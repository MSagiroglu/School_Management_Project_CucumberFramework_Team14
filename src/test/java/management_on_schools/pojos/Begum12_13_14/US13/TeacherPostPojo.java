...
public class TeacherPostPojo implements Serializable {
	...
	public TeacherPostPojo(String birthDay, String birthPlace, String email, String gender, boolean isAdvisorTeacher, List<Long> lessonsIdList, String name, String password, String phoneNumber, String ssn, String surname, String username) {
	...
	public void setLessonsIdList(List<Long> lessonsIdList){
		this.lessonsIdList = lessonsIdList;
	}

	public List<Long> getLessonsIdList(){
